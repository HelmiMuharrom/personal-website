...
document.getElementById("experienceButton").addEventListener("click", function() {
  window.open("https://www.linkedin.com/in/muhammad-helmi-muharrom/", "_blank");
});
...
window.onload = function () {
  ...
  var readingTimeInMinutes = Math.ceil(words / 700);
  readingTime.innerText = "Estimated reading time: " + readingTimeInMinutes + " minutes";
}
